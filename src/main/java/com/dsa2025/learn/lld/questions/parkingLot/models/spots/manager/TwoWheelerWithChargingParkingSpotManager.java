package com.dsa2025.learn.lld.questions.parkingLot.models.spots.manager;

import com.dsa2025.learn.lld.questions.parkingLot.models.spots.ParkingSpot;
import com.dsa2025.learn.lld.questions.parkingLot.models.spots.TwoWheelerWithChargingParkingSpot;
import com.dsa2025.learn.lld.questions.parkingLot.strategy.parking.ParkingStrategy;

import java.util.List;

public class TwoWheelerWithChargingParkingSpotManager extends ParkingSpotManager {

    public TwoWheelerWithChargingParkingSpotManager(List<ParkingSpot> parkingSpotList,
    ...
    public Boolean addParkingSpace(ParkingSpot parkingSpot) {
        if (parkingSpot instanceof TwoWheelerWithChargingParkingSpot) {
