...
public abstract class ParkingSpotManager {
     ...
     * @return Boolean
     */
    public Boolean parkVehicle(ParkingSpot availableSpot, Vehicle vehicle) {
    ...
    public Optional<Vehicle> removeVehicle(String vehicleNo) {
        for (ParkingSpot parkingSpot : parkingSpotList) {
            ...
            if (!parkingSpot.isEmpty() && parkingSpot.getParkedVehicle().vehicleNo().equalsIgnoreCase(vehicleNo)) {
